...
raccoong_sample_gaussian_vec(sp_flat, RACCOONG_44_L, randomness, RACCOONG_44_RERAND_BYTES, "Raccoon-G-44/RandPK/s'");
raccoong_sample_gaussian_vec(ep_flat, RACCOONG_44_K, randomness, RACCOONG_44_RERAND_BYTES, "Raccoon-G-44/RandPK/e'");
...
int32_t sp_flat[RACCOONG_44_L * RACCOONG_44_N];
int32_t (*sp)[RACCOONG_44_N] = (int32_t (*)[RACCOONG_44_N])sp_flat;
raccoong_sample_gaussian_vec(sp_flat, RACCOONG_44_L, randomness, RACCOONG_44_RERAND_BYTES, "Raccoon-G-44/RandSK/s'");
